...
Maintain detailed plans in `.roocode/plans/` documenting:
...
Task logs are critical to maintaining project continuity across memory resets. They must be systematically maintained in the `.roocode/task-logs/` directory.
...
<FunctionMap>
  ...
  <WorkflowFunctions>
    ...
    <Phase name="Planning">
      ...
      <Function id="documentPlanning">Document the project plan in chat and .roocode/plans/</Function>
    ...
    <Phase name="Implementation">
      ...
      <Function id="updatePlans">Update .roocode/plans/ with current implementation details</Function>
  ...
  <LearningFunctions>
    ...
    <Function id="documentInTaskLogs">Document patterns in .roocode/task-logs/</Function>
